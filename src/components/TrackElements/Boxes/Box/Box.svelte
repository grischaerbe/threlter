...
Command: npx @threlte/gltf@1.0.0-next.9 /Users/grischaerbe/Documents/Projects/2023/threltemania/src/components/TrackElements/Boxes/Box/Box.glb -u -i -t -s
-->
<script lang="ts">
	...
	const gltf = suspend(useGltf<GLTFResult>('/Box.glb'))
