...
<!-- <UserTrackSelection
	...
	selectedTrackId={data.selectedTrackId}
	on:trackSelected={(e) => {
		goto(`/menu/my-tracks/${e.trackId}`)
	}}
>
	<slot />

	<div
		class="bottom-0 pb-[15px] bg-gradient-to-t from-blue-950 to-transparent pt-[60px] left-0 w-full justify-center absolute flex flex-row gap-[15px] text-[1
		em]"
	>
		<SpecialButton
			style="inverted"
