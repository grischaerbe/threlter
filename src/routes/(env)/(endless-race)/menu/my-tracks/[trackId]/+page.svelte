<script lang="ts">
	...
	$: showValidate = UserManager.isSelf(track.userId) && !track.public
	$: showEdit = UserManager.isSelf(track.userId) && !track.public
	$: showDelete = UserManager.isSelf(track.userId) && !track.public
</script>
